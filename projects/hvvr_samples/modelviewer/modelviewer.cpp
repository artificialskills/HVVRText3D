...
// which scene to load?
static ModelviewerScene gSceneSelect = scene_cornell_textured;
...
void gOnInit() {
    ...
    switch (gSceneSelect) {
        case scene_cornell:
            // Oculus Home
            gCameraPos = hvvr::vector3(0.0f, .60f, 1.5f);
			gCameraYaw = (-4)*3.1415 / 180.f;
			gCameraPitch = (0)*3.1415 / 180.f;
            scenePath = sceneBasePath + "cornell.bin";
            break;

        case scene_cornell_textured:
            // Stanford Bunny
			gCameraPos = hvvr::vector3(0.0f, .60f, 1.5f);
			gCameraYaw = (-4)*3.1415 / 180.f;
			gCameraPitch = (0)*3.1415 / 180.f;
			scenePath = sceneBasePath + "cornell_textured.bin";
			break;
